		...
		<nav
			...
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link" data-widget="pushmenu"
					href="admin" role="button"><i class="fas fa-bars"></i></a></li>
...
<!-- 						<li class="nav-item menu-open"><a href="#"
							...
							<tbody>
								<c:forEach items="${users}" var="item">
									<tr>
										...
										<td>
											<a href="<c:url value='/admin/user?action=edit&username=${item.username}'/>"
													type="button" class="btn btn-block btn-success btn-sm">Edit
											</a>
											<button id="deleteBtn" type="button" onclick="deleteUser('${item.username}')"
	...
	<script>
		function deleteUser(username) {
			$.ajax({
				url: '/java4asm/admin/user?action=delete&username=' + username
			}).then(function(data) {
				window.location.username = "http://localhost:8080/java4asm/admin/user?action=view";
			}).fail(function(error) {
