...
<!-- 						<li class="nav-item menu-open"><a
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="/admin/user?action=view"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Overview</p>
								</a></li>
								<li class="nav-item"><a href="/admin/user?action=add"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>New or Edit</p>
								</a></li>
							</ul></li> -->
			...
			<section class="content">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">List Videos</h3>
					</div>
					<!-- /.card-header -->
					<div class="card-body">
									...
									<tr>
										...
										<td><a
											...
											<button id="deleteBtn" type="button"
												...
												class="btn btn-block btn-danger btn-sm">Delete</button></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
	...
	<script>
		function deleteVideo(href) {
			$.ajax({
				url: '/java4asm/admin/video?action=delete&href=' + href
			}).then(function(data) {
