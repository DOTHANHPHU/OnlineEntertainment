...
<!-- 						<li class="nav-item menu-open"><a
							href="<c:url value='/admin/user?action=view'/>" class="nav-link"> <i
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="<c:url value='/admin/user?action=view'/>"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Overview</p>
								</a></li>
								<li class="nav-item"><a href="<c:url value='/admin/user?action=add'/>"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>New or Edit</p>
								</a></li>
							</ul></li> -->
			...
			<section class="content">
				<div class="container-fluid">
					<div class="row">
						...
						<h5 id="message" style="color: red; text-align: center"></h5>
					</div>
				</div>
			</section>
			<br />
	...
	<script>
		...
		$('#submitBtn')
				.click(function() {
						...
						if (isEdit == 'true') {
							url = '/java4asm/admin/video?action=edit&href=' + hrefOrigin;
						} else {
							url = '/java4asm/admin/video?action=add';
						}
						...
						$.ajax({
							...
							data : formData
								...
								window.location.href = "http://localhost:8080/java4asm/admin/video?action=view";
						}).fail(function(error) {
