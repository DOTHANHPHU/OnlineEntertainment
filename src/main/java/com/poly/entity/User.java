...
public class User {
	...
	public Boolean getIsAdnmin() {
		return isAdnmin;
	}
	public void setIsAdnmin(Boolean isAdnmin) {
	...
	public User(Integer id, String username, String password, String email, Boolean isAdnmin, Boolean isActive) {
		super();
		this.id = id;
		this.username = username;
		this.password = password;
